    ...
    <div className="space-y-6">
      ...
      <div className="chameleon-gradient rounded-2xl p-6 lg:p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-headline text-3xl lg:text-4xl font-extrabold tracking-tight mt-1">
                  ...
                  <div className="flex items-center justify-center my-5">
                    <div className="relative w-32 h-32">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-2xl font-black tracking-tighter" style={{ color: okr.color }}>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={marketData} layout="vertical" barSize={28}>
                  ...
                  <YAxis type="category" dataKey="name" tick={{ fontSize: 12, fill: '#534341' }} axisLine={false} tickLine={false} width={130} />
                  <Tooltip
      ...
      {activeTab === 'operacional' && (
        <div className="space-y-6">
          ...
          <div className="chameleon-gradient rounded-2xl p-6 lg:p-8 text-white relative overflow-hidden">
            <div className="absolute -bottom-16 -right-16 w-48 h-48 rounded-full bg-white/5 blur-2xl" />
            <div className="relative z-10">
              <p className="text-[11px] font-black uppercase tracking-widest text-white/60 mb-2">Evento Ativo Hoje</p>
              <h2 className="text-2xl lg:text-3xl font-extrabold tracking-tight font-headline">ABRAMULTI STREAMING 2026</h2>
